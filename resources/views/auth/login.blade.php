...
@section('content')
<div class="
flex flex-col items-center h-dvh justify-center">
  <h1 class="text-center 
  dark:text-white font-bold">Login Admin</h1>
  <form class="max-w-sm mx-auto p-10 pb-0" method="POST" action="/login/auth">
    @csrf
    <div class="mb-5">
