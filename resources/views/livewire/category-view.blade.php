<div>
    ...
    <div class="flex justify-between pt-28 px-16">
        {{-- Title --}}
        <h1 class="text-xl font-bold capitalize text-slate-900 dark:text-white md:text-2xl">
        ...
        <div>
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center">
                    <a class="inline-flex items-center text-sm font-medium text-slate-700 dark:text-slate-300 dark:hover:text-white">
                        <svg class="h-6 w-6 text-slate-500 transition hover:text-cyan-600 dark:text-slate-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <p class="pl-2.5 font-semibold capitalize text-slate-900 hover:text-cyan-600 dark:text-white">
                            {{ str_replace('-', ' ', $category) }}
                        </p>
                    </a>
                </li>
                <li>
                    <div class="flex items-center">
                        <svg class="mx-1 h-3 w-3 text-slate-400 transition hover:text-cyan-600 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
                        </svg>
                        <p class="ms-1 text-sm font-semibold text-slate-700 hover:text-cyan-600 md:ms-2 dark:text-slate-300 dark:hover:text-white">Post</p>
                    </div>
                </li>
            </ol>
        </div>
