<div>
    ...
    <div class="flex justify-between pt-28 px-16">
        {{-- Title --}}
        <h1 class="text-gray-700 text-xl md:text-2xl font-bold capitalize ">
        ...
        <div>
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center">
                    <a class="inline-flex items-center text-sm font-medium text-gray-700 dark:text-gray-400 dark:hover:text-white">
                        <svg class="w-6 h-6 hover:text-blue-600 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <p class="pl-2.5 font-semibold hover:text-blue-600 capitalize">
                            {{ str_replace('-', ' ', $category) }}
                        </p>
                    </a>
                </li>
                <li>
                    <div class="flex items-center">
                        <svg class="rtl:rotate-180 hover:text-blue-600 w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"/>
                        </svg>
                        <p class="ms-1 font-semibold text-sm text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Post</p>
                    </div>
                </li>
            </ol>
        </div>
