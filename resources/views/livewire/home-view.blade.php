<div>
    ...
    <div id="breadcrumb"
        ...
        <div class="titleBc">
            <p class="font-semibold text-slate-900 dark:text-slate-100">{{ $siteSettings->site_title }}</p>
        </div>
    ...
    <div class="pb-16 sm:mt-16 sm:grid sm:grid-cols-12 sm:pb-20 lg:mx-10 lg:pb-24">
        ...
        <div id="paginated-posts" class="m-7 sm:m-0 sm:col-span-7 sm:mx-5 lg:col-span-9 lg:mx-4">
            ...
            <div class="container">
                ...
                <div wire:loading.grid wire:target="search" class="grid gap-9 sm:grid-cols-1 sm:gap-5 lg:grid-cols-2 lg:gap-9">
                    @for ($i = 0; $i < 4; $i++)
                ...
                <div wire:loading.remove wire:target="search">
                    <div id="contents" class="grid gap-9 sm:grid-cols-1 sm:gap-5 lg:grid-cols-2 lg:gap-9">
                    ...
                    @if ($hasMoreContents)
                        ...
                        <div wire:loading.grid wire:target="loadMore" class="mt-8 grid gap-9 sm:grid-cols-1 sm:gap-5 lg:grid-cols-2 lg:gap-9">
                            @for ($i = 0; $i < 2; $i++)
                                @include('livewire.partials.post-card-skeleton')
                            @endfor
                        </div>
